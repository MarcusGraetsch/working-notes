...
The CSS is hand-written, minimal, and targeted at readability above all else:

- Georgia for body text (system serif, available everywhere)
- ~18px base size with 1.7 line height
- Maximum width of 680px for comfortable reading
- No tracking, no analytics, no cookies
- Dark text on light background (print-friendly)

The visual language is intentionally austere. The focus is on the text.
